	...
	public static void main(String[] args)
	{
		...
		try {
			...
			while (true)
			{
				...
				System.out.println("Message from " + sender_address + " on port " + sender_port +
								   " of length " + message_len + ": " + message + ".");
				...
				try {
					...
					packet = new DatagramPacket(response_data, response_data.length,
												sender_address, response_port);
